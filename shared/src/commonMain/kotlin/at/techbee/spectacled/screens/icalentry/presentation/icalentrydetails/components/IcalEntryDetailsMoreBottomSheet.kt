...
fun IcalEntryDetailsMoreBottomSheet(
    ...
    BottomSheetWithMenu(
        onDismiss = { onAction(IcalEntryDetailsAction.OnShowMoreBottomSheet(false)) },
    ) {
        ...
        DropdownMenuItem(
            ...
            onClick = {
                onAction(IcalEntryDetailsAction.OnShowMoreBottomSheet(false))
                onAction(IcalEntryDetailsAction.OnCreateCopy)
        ...
        DropdownMenuItem(
            ...
            onClick = {
                ...
                onAction(IcalEntryDetailsAction.OnUpdateSnackbar(copiedToClipboardText))
            },
            colors = MenuDefaults.itemColors().copy(
                textColor = MaterialTheme.colorScheme.primary,
                leadingIconColor = MaterialTheme.colorScheme.primary
