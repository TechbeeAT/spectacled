...
object TimeZoneSerializer : KSerializer<TimeZone> {
    init {
        // Referencing this here makes it part of the app's reachable graph, so on the web targets
        // the @js-joda/timezone import is pulled into the bundle and its database registers at load.
    ...
    // parser (IcalEntryIcsParser). This also guards the web targets should the tz database ever be
    // unavailable, rather than crashing while loading a stored entry with a named zone.
