                        ...
                        if (state.calendar.canWriteContent()) {
                            ExtendedFloatingActionButton(
                                ...
                                Row(
                                    ...
                                    Icon(
                                        painter = painterResource(when(listViewModel.spectacledVariant) {
                                        ...
                                        contentDescription = stringResource(when(listViewModel.spectacledVariant) {
                                        ...
                                        tint = getContentColorForColoredSurfaces(listViewModel.state.calendar.color, true)
                                    )

                                    Text(
                                        text = stringResource(when(listViewModel.spectacledVariant) {
                                            SpectacledVariant.JOURNALS -> Res.string.add_journal
                                            SpectacledVariant.NOTES -> Res.string.add_note
                                            SpectacledVariant.TASKS -> Res.string.add_task
                                        }),
                                        color = getContentColorForColoredSurfaces(listViewModel.state.calendar.color, true)
                                    )
                                }
                            }
                        } else {
