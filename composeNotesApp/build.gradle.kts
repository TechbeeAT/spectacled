...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            ...
            freeCompilerArgs += listOf("-Xbinary=bundleId=at.techbee.spectacled.notes.ios")
        }
    }
...
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            windows {
                iconFile.set(project.file("src/commonMain/composeResources/drawable/icon_notes_ico.ico"))
